# Spitch Node API Library

[![NPM version](https://img.shields.io/npm/v/spitch.svg)](https://npmjs.org/package/spitch) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/spitch)
...
add the following import before your first import `from "Spitch"`:
